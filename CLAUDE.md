...
cd VideoNote_frontend && pnpm tauri build
```
...
**Frontend** (`VideoNote_frontend/src/`) — React 19 + Vite + Tailwind + shadcn/ui:
...
- **Note**: The frontend directory is named `VideoNote_frontend` (not "Bili").
