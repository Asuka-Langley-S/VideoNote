      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16 flex flex-col items-center justify-center text-center">
          <div className="mb-4 flex items-center gap-4">
            ...
            />
            <h1 className="text-4xl font-bold">VideoNote v{appVersion}</h1>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-lg">
              VideoNote 是一个开源的 AI 视频笔记助手，支持通过哔哩哔哩、抖音、快手等视频链接，
          ...
          <div className="mx-auto max-w-3xl">
            <div className="flex flex-col items-center justify-center gap-10 md:flex-row md:items-start">
              <div className="text-center">
                <h3 className="mb-3 text-xl font-semibold">VideoNote 公众号</h3>
                <div className="bg-muted mx-auto flex h-52 w-52 items-center justify-center rounded-md">
                  <img src={wechatQr} alt="VideoNote 公众号" className="h-full w-full object-contain" />
                </div>
                <p className="text-muted-foreground mt-3 text-sm">扫描公众号，回复「交流群」获取二维码</p>
              </div>
              <div className="text-center">
                <h3 className="mb-3 text-xl font-semibold">VideoNote AI笔记系统一对一搭建服务</h3>
                <div className="bg-muted mx-auto flex h-52 w-52 items-center justify-center rounded-md">
                  <img
                    src={remoteInstallQr}
                    alt="VideoNote AI笔记系统一对一搭建服务"
