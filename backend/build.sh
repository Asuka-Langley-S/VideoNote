...
# 清理旧的构建
echo "清理旧的构建..."
rm -rf backend/dist backend/build ./VideoNote_frontend/src-tauri/bin/*
echo "清理完成。"
...
# 重命名主执行文件以包含目标平台信息
mv \
 ./VideoNote_frontend/src-tauri/bin/VideoNoteBackend/VideoNoteBackend\
 ./VideoNote_frontend/src-tauri/bin/VideoNoteBackend/VideoNoteBackend-$TARGET_TRIPLE

echo "PyInstaller 打包完成。"
echo "打包后的目录内容："
ls -l ./VideoNote_frontend/src-tauri/bin/VideoNoteBackend
